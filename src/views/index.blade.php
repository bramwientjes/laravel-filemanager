...
<head>
  ...
  <style>{!! \File::get(base_path('vendor/puikepixels/laravel-filemanager/public/css/lfm.css')) !!}</style>
...
<body>
  ...
  <script>{!! \File::get(base_path('vendor/puikepixels/laravel-filemanager/public/js/script.js')) !!}</script>
